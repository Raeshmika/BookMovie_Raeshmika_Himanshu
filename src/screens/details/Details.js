...
const Details = (props) => {
    ...
    useEffect(()=>{
        let filteredData=fetch("http://localhost:8085/api/v1/"+"movies/"+props.movieId);
...
*/
    ...
    return (
            <div className="details">
                <Header id={props.movieId} baseUrl="http://localhost:8085/api/v1/" showBookShowButton="true" />
                <div className="back">
                    <Typography>
